export class VersionConflictError extends Error {
  ...
  constructor(
    readonly entityType: "Knowledge" | "Learning" | "Customer" | "Contact" | "Opportunity",
...
export function throwDomainCommandError(
  error: unknown,
  options: { entityType: "Knowledge" | "Learning" | "Customer" | "Contact" | "Opportunity"; expectedVersion?: number; fallback: string },
): never {
